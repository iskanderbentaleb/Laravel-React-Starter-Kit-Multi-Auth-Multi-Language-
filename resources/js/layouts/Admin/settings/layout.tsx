    ...
    return (
        <div className="sticky top-0 z-40 border-b bg-background/95 pb-4 pt-5 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="mb-4 px-4 md:px-6 flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-bold tracking-tight">{t('components.settings_layout.admin_settings')}</h1>
                    <p className="text-sm text-muted-foreground text-xs md:text-sm">{t('components.settings_layout.manage_admin_preferences')}</p>
                </div>
        ...
        <div className="mb-10">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">{t('components.settings_layout.admin_settings')}</h1>
                        <p className="text-muted-foreground">{t('components.settings_layout.manage_admin_preferences')}</p>
                    </div>
                </div>
            </div>
